    ...
    public class Vampire : Monster
    {
        ...
        public override string ToString()
        {
            return string.Format("{0}\n{1}", base.ToString(),
                HourChangeBack.Hour < 6 || HourChangeBack.Hour > 18 ? "It looks a little strong and angry..." : "In the daylight, it's looking a bit weak to you. Tread with caution still.");
        }
    }
}
